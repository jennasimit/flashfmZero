...
facheck <- fa.parallel(covY, fm="ml", n.obs=median_nonmissing2,fa="fa",show.legend=F,main="") # use median non-missing pairwise
...
```
Latent GWAS estimation and fine-mapping is described in [Latent factor GWAS and fine-mapping](https://jennasimit.github.io/flashfmZero/articles/Example_Part2.html).
