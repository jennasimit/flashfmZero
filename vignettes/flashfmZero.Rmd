...
Example scripts that only use observed trait summary-level data in our analysis of the INTERVAL study's blood cell traits and NMR metabolic traits are available at:
