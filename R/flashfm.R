...
##' @param Nqq matrix in which  \code{Nqq[i,j]} = number of individuals  measured in both trait i and  trait j
...
#' @param Mx vector of SNP means
#' @param Nqq has  \code{N[i,j]} = no. with  both trait i and trait j measured
#' @author Jenn Asimit
...
#Feng20240717: copied from MGflashfm.R script
