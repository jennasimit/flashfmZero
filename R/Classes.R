...
#' 
#' @slot likelihood Likelihood type of model. See R2BGLiMS for the options.
...
#' @slot model.space.prior List defining the model space prior. See R2BGLiMS.
#' @slot beta.prior.partitions List defining the covariate effect prior partitions. See R2BGLiMS.
