...
#' @importFrom graphics axis abline points points text lines layout barplot
#' @export
#' @title Manhattan Plot
#' @name ManhattanPlot
#' @param results A R2BGLiMS R2BGLiMS_Results-class object frum running the R2BGLiMS R2BGLiMS command.
